...
export default function CTFSection() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      >
        <Card className="bg-gray-800/80 backdrop-blur-sm border-gray-700 h-full hover:border-purple-500/50 transition-all duration-300 purple-glow-hover">
          <CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {ctfCategories.map((category, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-gray-900/50 p-4 rounded-lg border border-gray-700 hover:border-purple-500/30 transition-all duration-300"
                >
                  <div className="flex items-center gap-3 mb-2">
                    {category.icon}
            ...
            <div className="mt-8 p-4 bg-gray-900/50 rounded-lg border border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-800/80 p-3 rounded-lg text-center">
                  <span className="block text-purple-500 font-bold text-lg mb-1">01</span>
                  <span className="text-sm">Fundamentals & Theory</span>
                </div>
                <div className="bg-gray-800/80 p-3 rounded-lg text-center">
                  <span className="block text-purple-500 font-bold text-lg mb-1">02</span>
                  <span className="text-sm">Guided Practice</span>
                </div>
                <div className="bg-gray-800/80 p-3 rounded-lg text-center">
                  <span className="block text-purple-500 font-bold text-lg mb-1">03</span>
