...
export default function AchievementsTimeline() {
  const achievements = [
    ...
    },
    {
      ...
      description: "First place in the Fintech Ideathon for innovative security solution.",
    },
    {
      year: "2024",
    ...
    },
    {
      ...
      icon: <Certificate className="h-6 w-6 text-emerald-500" />,
  ...
  return (
    <div className="relative">
      {/* Vertical line */}
      <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-emerald-500 to-cyan-500 transform md:translate-x-px"></div>
      ...
      <div className="space-y-12">
        {achievements.map((achievement, index) => (
          ...
          >
            {/* Timeline dot */}
            <div className="absolute left-0 md:left-1/2 w-5 h-5 bg-emerald-500 rounded-full transform -translate-x-2 md:-translate-x-2.5 z-10 shadow-lg shadow-emerald-500/50"></div>
            ...
            <div className="absolute left-6 md:static md:flex-none md:w-1/2 flex md:justify-center">
              <div
                className={`bg-gray-800 text-emerald-500 font-bold py-1 px-3 rounded-full inline-block ${
